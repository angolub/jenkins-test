...
public class MestoTest {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzJkMjlmZTNhMDdkZjAwM2QxMjJhOTciLCJpYXQiOjE3Mzc1NjkyNTcsImV4cCI6MTczODE3NDA1N30.AjAIaNZQjSvqhyre9ELmb54P9m88R4ZjJ-nDBSKc_A0";
    ...
    public void addNewPhoto() {
        given()
                .header("Content-type", "application/json") // Пере -даём Content-type в заголовке для указания типа файла
